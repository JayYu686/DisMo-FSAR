...
def build_model(cfg, gpu_id=None):
    ...
    if cfg.NUM_GPUS*cfg.NUM_SHARDS > 1:
        find_unused_parameters = bool(getattr(cfg.TRAIN, "DDP_FIND_UNUSED_PARAMETERS", False))
        find_unused_parameters = find_unused_parameters or bool(
            getattr(getattr(cfg, "STRA", None), "ENABLE", False)
        )
